...
@RegisterFluid(name = "fluid_obsidian", registerBucket = true)
public class FluidObsidian extends PhosphophylliteFluid {
    
    @RegisterFluid.Instance
    public static FluidObsidian INSTANCE;
    ...
    public FluidObsidian(@Nonnull Properties properties) {
        super(properties);
    }
