...
public class ERS2 extends BaseReactorSimulation {
    protected ERS2(SimulationDescription simulationDescription) {
                ...
                for (int j = 0; j < SimUtil.rays.size(); j++) {
                    ...
                    for (int k = 0; k < raySteps.size(); k++) {
                        ...
                        if (properties != null) {
                            ...
                            final double scaledAbsorption = baseAbsorption * FuelAbsorptionCoefficient * 1;
